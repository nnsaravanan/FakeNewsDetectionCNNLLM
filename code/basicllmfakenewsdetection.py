...
prompt = 'can you determine whether this article is fake based on the structure of the text and tone, just say fake or real:'
safe = [
    {
...
if __name__ == "__main__":
    ...
    for ct, values in enumerate(zip(texts, labels), start=1):  # Start counting from 1
        ...
        try:
            ...
            guess = mapping[response.text.lower()]
            if label == guess == 1:
                conf['tp'] += 1
            elif label == guess == 0:
                conf['tn'] += 1
